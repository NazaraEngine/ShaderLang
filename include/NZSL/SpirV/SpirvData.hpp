...
namespace nzsl
{
	...
	constexpr std::uint32_t SpirvRevision = 7;
	...
	enum class SpirvMatrixMultiplyAccumulateOperands
	{
		None = 0x0,
	...
	enum class SpirvCooperativeVectorMatrixLayout
	{
		RowMajorNV = 0,
		ColumnMajorNV = 1,
	...
	enum class SpirvTensorOperands
	{
		NoneARM = 0x0000,
	...
	NZSL_API std::pair<const SpirvOperand*, std::size_t> GetSpirvExtraOperands(SpirvComponentType kind);
	...
	NZSL_API std::pair<const SpirvOperand*, std::size_t> GetSpirvExtraOperands(SpirvCooperativeVectorMatrixLayout kind);
	...
	NZSL_API std::string_view ToString(SpirvComponentType value);
	...
	NZSL_API std::string_view ToString(SpirvCooperativeVectorMatrixLayout value);
...
namespace Nz
{
	...
	{
		static constexpr nzsl::SpirvLoopControl max = nzsl::SpirvLoopControl::MaxReinvocationDelayALTERA;
	...
	{
		static constexpr nzsl::SpirvRayFlags max = nzsl::SpirvRayFlags::ForceOpacityMicromap2StateKHR;
	...
	template<>
	struct EnumAsFlags<nzsl::SpirvMatrixMultiplyAccumulateOperands>
	{
		static constexpr nzsl::SpirvMatrixMultiplyAccumulateOperands max = nzsl::SpirvMatrixMultiplyAccumulateOperands::MatrixBPackedBFloat16INTEL;
	...
	template<>
	struct EnumAsFlags<nzsl::SpirvTensorOperands>
	{
		static constexpr nzsl::SpirvTensorOperands max = nzsl::SpirvTensorOperands::NonPrivateElementARM;
