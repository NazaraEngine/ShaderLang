...
namespace nzsl
{
	...
	void GlslWriter::RegisterPasses(Ast::TransformerExecutor& executor)
	{
		static constexpr auto s_reservedKeywords = frozen::make_unordered_set<frozen::string>({
			...
			"abs", "acos", "acosh", "asin", "asinh", "atan", "atanh", "ceil", "clamp", "cos", "cosh", "cross", "degrees", "distance", "dot", "exp", "exp2", "floor", "fract", "imageLoad", "imageSize", "imageStore", "inverse", "inversesqrt", "length", "log", "log2", "max", "min", "mix", "normalize", "pow", "radians", "reflect", "round", "roundEven", "sign", "sin", "sinh", "sqrt", "tan", "tanh", "texelFetch", "texture", "textureLod", "textureSize", "transpose", "trunc",
		});
