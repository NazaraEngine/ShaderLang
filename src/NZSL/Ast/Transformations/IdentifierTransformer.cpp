...
namespace nzsl::Ast
{
	...
	StatementPtr IdentifierTransformer::Transform(ForEachStatement&& forEachStatement)
	{
	...
	StatementPtr IdentifierTransformer::Transform(ForStatement&& forStatement)
	{
	...
	void IdentifierTransformer::SanitizeIdentifier(std::string& identifier, IdentifierType scope)
	{
	}
